...
export const promissoryKeys = ["alliance","ceasefire","politicalSecret","supportForTheThrone","tradeDeal"];

export const promissories = {
	alliance:{
		name:"Alliance",
		desc:"When you receive this card, if you are not the %s player, you must place it face up in your play area.</p><p>While this card is in your play area, you can use the %s player's commander ability, if it is unlocked.</p><p>If you activate a system that contains 1 or more of the %s player's units, return this card to the %s player."
	},
	ceasefire:{
		name:"Ceasefire",
		desc:"After the %s player activates a system that contains 1 or more of your units:</p><p>The %s player cannot move units into the active system.</p><p>Then, return this card to the %s player."
	},
	politicalSecret:{
		name:"Political Secret",
		desc:"Then an agenda is revealed:</p><p>The %s player cannot vote, play action cards, or use faction abilities until after that agenda has been resolved.</p><p>Then, return this card to the %s player."
	},
	supportForTheThrone:{
		name:"Support for the Throne",
		desc:"When you receive this card, if you are not the %s player, you must place it face-up in your play area and gain 1 Victory Point.</p><p>If you activate a system that contains 1 or more of the %s player's units or if the %s player is eliminated, lose 1 Victory Point and return this card to the %s player."
	},
	tradeAgreement:{
		name:"Trade Agreement",
		desc:"When the %s player replenishes commodities:</p><p>The %s player gives you all of their commodities.</p><p>Then, return this card to the %s player."
	}
};
...
export const strategies = {
	leadership:{
		name:"Leadership",
		priority:"1",
		primary:"Gain 3 command tokens.</p><p>Spend any amount of influence to gain 1 command token for every 3 influence spent.",
	...
	politics:{
		name:"Politics",
		priority:"3",
		primary:"Choose a player other than the speaker. That player gains the speaker token.</p><p>Draw 2 action cards.</p><p>Look at the top 2 cards of the agenda deck. Place each card on the top or bottom of the deck in any order.",
		secondary:"Spend 1 token from your strategy pool to draw 2 action cards."
	},
	construction:{
		name:"Construction",
		priority:"4",
		primary:"Either place 1 structure on a planet you control or use the PRODUCTION ability of 1 of your space docks.</p><p>Place 1 structure on a planet you control.",
		secondary:"Spend 1 token from your strategy pool to place 1 structure on a planet you control."
	},
	trade:{
		name:"Trade",
		priority:"5",
		primary:"Gain 3 trade goods.</p><p>Replenish commodities.</p><p>Choose any number of other players. Those players use the secondary ability of this strategy card without spending a command token.",
	...
	technology:{
		name:"Technology",
		priority:"7",
		primary:"Research 1 technology.</p><p>Spend 6 resources to research 1 technology.",
		secondary:"Spend 1 token from your strategy pool and 4 resources to research 1 technology."
	},
	imperial:{
		name:"Imperial",
		priority:"8",
		primary:"Immediately score 1 public objective if you fulfill its requirements.</p><p>Gain 1 Victory Point if you control Mecatol Rex; otherwise, draw 1 secret objective.",
...
export const technologies = {
	propulsion:{
		...
		antimassDeflectors:{
			...
			prereq:"",
			desc:"Your ships can move into and through asteroid fields.</p><p>When other players' units use SPACE CANNON against your units, apply -1 to the result of each die roll."
		},
		darkEnergyTap:{
			name:"Dark Energy Tap",
			prereq:"",
			desc:"After you perform a tactical action in a system that contains a frontier token, if you have 1 or more ships in that system, explore that token.</p><p>Your ships can retreat into adjacent systems that do not contain other players' units, even if you do not have units or control planets in that system."
		},
		gravityDrive:{
			name:"Gravity Drive",
			prereq:"B",
	...
	biotic:{
		...
		psychoarchaeology:{
			...
			prereq:"",
			desc:"You can use technology specialties on planets you control without exhausting them, even if those planets are exhausted.</p><p>During the action phase, you can exhaust planets you control that have technology specialties to gain 1 trade good."
		},
		dacxiveAnimators:{
		...
		x89BacterialWeapon:{
			...
			prereq:"GGG",
			desc:"Double the hits produced by your units' BOMBARDMENT and ground combat rolls.</p><p>Exhaust each planet you use BOMBARDMENT against."
		}
	},
	warfare:{
		type:"Warfare",
		...
		aiDevelopmentAlgorithm:{
			...
			prereq:"",
			desc:"When you research a unit upgrade technology, you may exhaust this card to ignore any 1 prerequisite.</p><p>When 1 or more of your units use PRODUCTION, you may exhaust this card to reduce the combined cost of the produced units by the number of unit upgrade technologies that you own."
		},
		magenDefenseGrid:{
			name:"Magen Defense Grid",
			prereq:"R",
			desc:"When any play activates a system that contains 1 or more of your structures, place 1 infantry from your reinforcements with each of those structures.</p><p>At the start of ground combat on a planet that contains 1 or more of your structures, produce 1 hit and assign it to 1 of your opponent's ground forces."
		},
		selfAssemblyRoutines:{
			name:"Self Assembly Routines",
			prereq:"R",
			desc:"After 1 or more of your units use PRODUCTION, you may exhaust this card to place 1 mech from your reinforcements on a planet that you control in that system.</p><p>after 1 of your mechs is destroyed, gain 1 trade good."
		},
		duraniumArmor:{
			name:"Duranium Armor",
			prereq:"RR",
	...
	cybernetics:{
		...
		scanlinkDroneNetwork:{
			...
			prereq:"",
			desc:"At the end of your turn, you may exhaust this card to redistribute your command tokens.</p><p>When you cast votes during the agenda phase, you may cast 3 additional votes; if you do, and the outcome you voted for is not resolved, exhaust this card."
		},
		gravitonLaserSystem:{
